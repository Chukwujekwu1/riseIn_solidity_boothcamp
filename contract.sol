...
contract Example {
    ...
    // This is our counter struct. 
    // It will hold necessary information about the counter which are number and description
    // it stores the variable that you want to use in your smart contract
    struct Counter {
        uint number;
        string description;
    }
